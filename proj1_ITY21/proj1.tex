%Prvni projekt do predmetu ITY 2020/2021.
...
\author{Alina Vinogradova \\ \href{mailto:xvinog00@stud.fit.vutbr.cz}{xvinog00@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
Čím více \emph{druhů}, \textbf{řezů}, {\tiny velikostí}, \textcolor{red}{barev} písma a jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\fontfamily{pzc}\selectfont {\LARGE dokument}} vypadat. {\Huge Č}{\huge t}{\LARGE e}{\large n}{\normalsize á}{\small ř} {\footnotesize t}{\scriptsize í}{\tiny m} bude vždy \textbf{\Huge{nadšen!}}
\end{quotation}
